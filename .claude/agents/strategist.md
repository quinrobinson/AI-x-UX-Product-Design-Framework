...
- `frame_problem` — Generate a structured problem statement with HMW questions and JTBD frames
...
6. **Prepare the handoff.** Close every session with a Phase Handoff Block for the Designer.
