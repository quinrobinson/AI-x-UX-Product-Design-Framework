...
const THEMES = {
  ...
  warmth: {
    ...
    surface: "#F5F4ED", surfaceSecondary: "#F0EFE8", border: "#E8E6DC",
    ...
    shadowSm: "0 0 0 1px rgba(20,20,19,0.08)", shadowMd: "0 0 0 1px rgba(20,20,19,0.12)", shadowLg: "rgba(20,20,19,0.05) 0px 4px 24px",
  ...
  wellness: {
    name: "Wellness", desc: "Health, meditation, consumer wellbeing",
    archetype: "Headspace",
    primary: "#5D8A6E", secondary: "#2C4A3E", accent: "#C8956C",
    success: "#5D8A6E", warning: "#D4A843", error: "#C4554D", info: "#6A9BCC",
    surface: "#FAF8F4", surfaceSecondary: "#F0ECE3", border: "#E0D8CC",
    textPrimary: "#1A2E26", textSecondary: "#5A6D5E", textTertiary: "#9AAE9F",
    fontHeading: "'DM Serif Display', serif", fontBody: "'Plus Jakarta Sans', sans-serif", fontMono: "'Roboto Mono', monospace",
    headingWeight: 400, baseSize: 16, scaleRatio: 1.333, spaceUnit: 4,
    radiusSm: 16, radiusMd: 24, radiusLg: 32, radiusFull: 9999,
    shadowSm: "0 2px 8px rgba(26,46,38,0.06)", shadowMd: "0 4px 16px rgba(26,46,38,0.08)", shadowLg: "0 8px 32px rgba(26,46,38,0.1)",
    motionFast: "200ms", motionNormal: "400ms",
    fonts: "DM+Serif+Display:ital@0;1&family=Plus+Jakarta+Sans:wght@400;500;600&family=Roboto+Mono:wght@400",
  },
  framework: {
    name: "Framework", desc: "Agent-native design tools, dark-first productivity",
    archetype: "APDF",
    primary: "#22C55E", secondary: "#161616", accent: "#8B5CF6",
    success: "#22C55E", warning: "#F59E0B", error: "#EF4444", info: "#3B82F6",
    surface: "#161616", surfaceSecondary: "#0F0F0F", border: "#2C2C2C",
    textPrimary: "#F2F2F2", textSecondary: "#999999", textTertiary: "#787878",
    fontHeading: "'Inter', sans-serif", fontBody: "'Inter', sans-serif", fontMono: "'JetBrains Mono', monospace",
    headingWeight: 600, baseSize: 14, scaleRatio: 1.25, spaceUnit: 4,
    radiusSm: 4, radiusMd: 8, radiusLg: 12, radiusFull: 9999,
    shadowSm: "0 1px 3px rgba(0,0,0,0.4)", shadowMd: "0 4px 16px rgba(0,0,0,0.5)", shadowLg: "0 8px 32px rgba(0,0,0,0.6)",
    motionFast: "120ms", motionNormal: "200ms",
    fonts: "Inter:wght@400;500;600;700&family=JetBrains+Mono:wght@400;500",
  },
  linear: {
    name: "Linear", desc: "Dev tools, productivity, minimal SaaS",
    archetype: "Linear",
    primary: "#5E6AD2", secondary: "#1A1A2E", accent: "#5E6AD2",
    success: "#4ADE80", warning: "#FB923C", error: "#F87171", info: "#60A5FA",
    surface: "#FFFFFF", surfaceSecondary: "#F8F8F9", border: "#EBEBEC",
    textPrimary: "#0D0D0D", textSecondary: "#5A5A72", textTertiary: "#9898AA",
    fontHeading: "'Inter', sans-serif", fontBody: "'Inter', sans-serif", fontMono: "'Berkeley Mono', 'JetBrains Mono', monospace",
    headingWeight: 600, baseSize: 13, scaleRatio: 1.125, spaceUnit: 4,
    radiusSm: 4, radiusMd: 6, radiusLg: 8, radiusFull: 9999,
    shadowSm: "none", shadowMd: "0 1px 2px rgba(0,0,0,0.04)", shadowLg: "0 2px 8px rgba(0,0,0,0.06)",
    motionFast: "60ms", motionNormal: "120ms",
    fonts: "Inter:wght@400;500;600;700&family=JetBrains+Mono:wght@400;500",
  },
  bloomberg: {
  ...
  neonDark: {
    name: "Neon Dark", desc: "AI products, developer tools, hacker aesthetic",
    archetype: "Raycast",
    primary: "#22D3EE", secondary: "#0E1117", accent: "#A855F7",
    success: "#4ADE80", warning: "#FACC15", error: "#F87171", info: "#22D3EE",
    surface: "#09090B", surfaceSecondary: "#111115", border: "#1F2028",
    textPrimary: "#F4F4F5", textSecondary: "#A1A1AA", textTertiary: "#52525B",
    fontHeading: "'Space Grotesk', sans-serif", fontBody: "'Inter', sans-serif", fontMono: "'JetBrains Mono', monospace",
    headingWeight: 700, baseSize: 14, scaleRatio: 1.25, spaceUnit: 4,
    radiusSm: 4, radiusMd: 8, radiusLg: 12, radiusFull: 9999,
    shadowSm: "0 0 8px rgba(34,211,238,0.15)", shadowMd: "0 0 16px rgba(34,211,238,0.2)", shadowLg: "0 0 32px rgba(34,211,238,0.25)",
    motionFast: "100ms", motionNormal: "200ms",
    fonts: "Space+Grotesk:wght@400;500;700&family=Inter:wght@400;500;600&family=JetBrains+Mono:wght@400;500",
  },
  figma: {
